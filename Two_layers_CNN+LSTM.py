...
a,b=createTrainData("rna-binding-all-1.csv")
t = (a, b)
cPickle.dump(t,open("rna-binding-all-1.pkl","wb"))
...
print('Loading data...')
(X_train, y_train), (X_test, y_test) = createTrainTestData("rna-binding-all-1.pkl",nb_words=max_features, test_split=0.2)
...
open('my_model_rna_1.json', 'w').write(json_string)
model.save_weights('my_model_rna_1_weights.h5')
